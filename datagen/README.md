...
- couche 3 (`generators/` — pas de décompte ici : le chiffre a périmé deux
  fois, `grep -o "from './generators/[a-z-]*'" datagen/build.ts | sort -u`
  donne le vrai ; characters/monsters n'en sont pas, ils vivent dans
  l'extracteur) ;
