...
export const WEEKLY_TASK_DEFINITIONS: Record<string, TaskDefinition> = {
  ...
  // Content > The Archdemon's Ruins Shop
  'shop-weekly-ruins-glunite': {
    id: 'shop-weekly-ruins-glunite',
    type: 'weekly',
    category: 'shop',
    labelKey: '',
    permanent: true,
    maxCount: 1,
    icon: 'TI_Item_Remains',
    shopCategory: 'progress.shop.contents',
    shopSubcategory: 'progress.shop.archdemon-ruins',
    shopItemKey: 'Refined Glunite',
    shopItemQuantity: 1,
  },
  ...
  // Content > Survey Hub
  'shop-weekly-survey-basic-manual': {
    id: 'shop-weekly-survey-basic-manual',
    type: 'weekly',
    category: 'shop',
    labelKey: '',
    permanent: true,
    icon: 'survey-contributions',
    maxCount: 3,
    shopCategory: 'progress.shop.contents',
  ...
  'shop-weekly-survey-intermediate-manual': {
    id: 'shop-weekly-survey-intermediate-manual',
    type: 'weekly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-weekly-survey-professional-manual': {
    id: 'shop-weekly-survey-professional-manual',
    type: 'weekly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-weekly-survey-glunite': {
    id: 'shop-weekly-survey-glunite',
    type: 'weekly',
    category: 'shop',
    labelKey: '',
    permanent: true,
...
export const MONTHLY_TASK_DEFINITIONS: Record<string, TaskDefinition> = {
  ...
  // Content > The Archdemon's Ruins Shop
  'shop-monthly-ruins-talisman': {
    id: 'shop-monthly-ruins-talisman',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  // Content > Skyward Tower
  'shop-monthly-skyward-free-ether': {
    id: 'shop-monthly-skyward-free-ether',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
    icon: 'TI_Item_Tower_Coin_01',
    maxCount: 500,
    shopCategory: 'progress.shop.contents',
  ...
  'shop-monthly-skyward-transistone-total': {
    id: 'shop-monthly-skyward-transistone-total',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-monthly-skyward-transistone-individual': {
    id: 'shop-monthly-skyward-transistone-individual',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-monthly-skyward-professional-manual': {
    id: 'shop-monthly-skyward-professional-manual',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-monthly-skyward-intermediate-manual': {
    id: 'shop-monthly-skyward-intermediate-manual',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-monthly-skyward-basic-manual': {
    id: 'shop-monthly-skyward-basic-manual',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
  ...
  'shop-monthly-skyward-recruitment-ticket': {
    id: 'shop-monthly-skyward-recruitment-ticket',
    type: 'monthly',
    category: 'shop',
    labelKey: '',
    permanent: true,
