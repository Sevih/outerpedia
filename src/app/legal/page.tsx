...
export async function generateMetadata(): Promise<Metadata> {
  return createPageMetadata({
    ...
    descKey: 'legal.meta.desc',
    ogTitleKey: 'legal.meta.ogTitle',
    ogDescKey: 'legal.meta.ogDesc',
    keywords: [
    ...
    image: {
      url: '/images/ui/nav/CM_Lobby_Button_Character.png',
      width: 150,
      height: 150,
      altFallback: 'Outerpedia Legal',
    },
  })
}
...
export default function LegalNoticePage() {
  return (
    <main className="p-4 max-w-3xl mx-auto">
      <h1 className="text-3xl font-bold mb-6">Legal Notice & Disclaimer | Outerpedia</h1>
