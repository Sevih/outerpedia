...
export const LABELS = {
  intro: {
    ...
    es: 'Hay varias formas de fortalecer a tus héroes: subir de nivel, limit break, trascender, gear, etc. Esta guía cubre cada método en detalle, con los costos exactos derivados de los datos del juego.',
  },
  ...
  tabGear: { en: 'Gear', jp: '装備', kr: '장비', zh: '装备', fr: 'Gear', es: 'Gear' },
  ...
  levelingDesc1: {
    ...
    es: 'Los héroes ganan experiencia participando en combates o consumiendo objetos de XP. La mayoría del contenido otorga XP, pero no todo. El modo desafío del Hypnotic Frog Hall te recompensa con comida de XP consumible.',
  },
  levelingDesc2: {
    ...
    es: 'Puedes usar varios objetos para otorgar XP:',
  },
  grantsXP: { en: 'grants', jp: '付与', kr: '부여', zh: '给予', fr: 'donne', es: 'otorga' },
  xpUnit: { en: 'XP', jp: '経験値', kr: '경험치', zh: '经验值', fr: 'XP', es: 'XP' },
  instantLv100: {
    ...
    es: 'sube instantáneamente a un héroe al nivel 100 (solo evento/tienda de pago).',
  },
  ...
  limitBreakDesc: {
    ...
    es: 'Una vez que un héroe alcanza el nivel 100, puedes extender el límite de nivel hasta el nivel 120 mediante Limit Break. Cada expansión consume Oro y Factores de Limit Break. Después de la expansión, se usa Comida normal para subir de nivel hasta el nuevo límite.',
  },
  limitBreakSource: {
    ...
    es: 'Los Factores de Limit Break se obtienen de la Singularidad Dimensional mediante la siguiente cadena de intercambio:',
  },
  ...
  limitBreakChainPerHero: {
    ...
    es: 'Factor de Limit Break (por héroe)',
  },
  colLvRange: {
    en: 'Lv. range',
    jp: 'Lv. 範囲',
  ...
  transcendenceDesc1: {
    ...
    es: 'Trascender mejora a los héroes usando fragmentos de héroe en lugar de piedras. Puedes obtenerlos invocando duplicados, mediante el desafío Doppelgänger, la tienda de héroes o eventos.',
  },
  transcendenceDesc2: {
    ...
    es: 'Nota: las unidades Demiurgo y Limitadas no se pueden farmear mediante Doppelgänger y sus trascendencias pueden tener bonos diferentes, a menudo incluyendo pasivas únicas en lugar de bonos de estadísticas (p. ej., {P/Demiurge Drakhan} reduce el daño en área) y no siguen los efectos de trascendencia genéricos.',
  },
  transcendenceDesc3: {
    ...
    es: 'Efectos de trascendencia genéricos (cada paso también incluye un bono base de estadística ATQ / DEF / VIDA):',
  },
  transcendenceNote: {
    ...
    es: 'Nota: necesitas 1 duplicado para avanzar en cada paso. Así que desde una base de 3★ necesitas 1 + 6 copias para alcanzar 6★.',
  },
  ...
  affinityDesc: {
    ...
    es: 'Aumentar el nivel de afinidad de un héroe desbloquea su Equipo exclusivo en el nivel 10. Puedes darle cualquier regalo, pero cada héroe tiene sus preferidos (revisa la preferencia de regalos en Héroe → Nivel de Afinidad, casilla superior izquierda). Se necesitan 170,000 puntos de afinidad en total para el nivel 10.',
  },
  bonus: { en: 'Bonus', jp: 'ボーナス', kr: '보너스', zh: '加成', fr: 'Bonus', es: 'Bono' },
  affinityMaxItem: {
    ...
    es: 'maximiza la afinidad al nivel 10 (solo evento/tienda de pago).',
  },
  affinityExpansionTitle: {
    ...
    es: 'Expansión del Nivel de Afinidad',
  },
  ...
  rewardStats: {
    ...
    es: 'Algunas estadísticas aumentadas',
  },
  rewardChat: {
    en: 'Chat added',
    jp: 'チャット追加',
  ...
  bondChatIntro: {
    ...
    es: 'Las funciones de Vínculo y Chat están disponibles en la pantalla de Afinidad de los héroes 3★. No están disponibles para héroes limitados de colaboración, ni para héroes de 2★ y 1★.',
  },
  bondDesc: {
    ...
    es: 'te permite inyectar un Regalo por día a un héroe de tu elección, potenciando las estadísticas de ese héroe durante 1 día, hasta el reinicio diario (00:00 UTC). Cuando el Nivel de Afinidad de un héroe alcanza 5 y 10, se desbloquean áreas táctiles adicionales. Los héroes compatibles se añaden progresivamente.',
  },
  chatDesc: {
    ...
    es: 'te permite charlar con un héroe una vez al día, hasta con 5 héroes diferentes por día. Según la opción de diálogo que elijas, la Afinidad del héroe aumenta.',
  },
  ...
  skillUpgradeDesc1: {
    ...
    es: 'Cada héroe tiene 3 skills básicas y 1 pasiva de cadena. Cada una puede mejorarse 4 veces para obtener efectos adicionales. La mejora se realiza en Héroe → Skills usando Libros de Skill obtenidos en eventos, tiendas, recompensas y Ark Raid.',
  },
  skillUpgradeDesc2: {
    ...
    es: 'El costo de mejorar una skill depende de la rareza base del héroe:',
  },
  colUpgradeLevel: {
    en: 'Upgrade Level',
    jp: '強化レベル',
  ...
  specialEquipmentDesc: {
    ...
    es: 'Se encuentra en Héroe → Equipo Especial. Hay dos tipos: Equipo Exclusivo (EE) y Talismanes.',
  },
  eeTitle: {
  ...
  eeDesc: {
    ...
    es: 'El EE se desbloquea mediante Afinidad y otorga una estadística pasiva, ganancia de AP condicional, una skill pasiva y espacios para gemas. Se mejora con:',
  },
  eeLv5Unlock: {
    ...
    es: 'El Nivel 5 desbloquea un espacio para gema adicional, el Nivel 10 desbloquea (o mejora) la pasiva.',
  },
  talismanTitle: {
    en: 'Talismans',
    jp: 'タリスマン',
  ...
  talismanDesc: {
    ...
    es: 'Los Talismanes otorgan un aumento de estadística en aura para todo el equipo, efectos de regeneración de CP/AP, y espacios para gemas. Se mejoran con Polvo de Estrellas (azul/morado), y siguen los mismos umbrales de gema/pasiva que el EE.',
  },
  auraNote: {
    ...
    es: 'Solo se aplica el efecto de aura más alto si hay duplicados (por ejemplo, dos aumentos de daño CRIT = solo se aplica el mayor).',
  },
  materialsSource: {
    ...
    es: 'Esos materiales se obtienen principalmente mediante Exterminio Irregular y eventos.',
  },
  gemsTitle: { en: 'Gems', jp: 'ジェム', kr: '보석', zh: '宝石', fr: 'Gems', es: 'Gemas' },
  gemsDesc1: {
    ...
    es: 'Las gemas son joyas especiales que pueden engastarse en el Equipo Exclusivo o los Talismanes. Su propósito principal es compensar las estadísticas faltantes de un héroe.',
  },
  gemsDesc2: {
    ...
    es: 'Por ejemplo, si una unidad DPS carece de Tasa CRIT, equipar un {I-I/Stage 6 Crit Chance Gem} puede ayudar a alcanzar umbrales clave. La elección de gemas siempre debe alinearse con las prioridades de sub-stats y el rol del personaje.',
  },
  colMaterials: {
    en: 'Materials',
    jp: '素材',
  ...
  gearIntro: {
    ...
    es: 'Para información detallada, consulta la Guía de Equipo. En resumen:',
  },
  gearEquipmentGuide: {
    en: 'Equipment Guide',
    jp: '装備ガイド',
...
export const GEAR_POINTS: LocalizedText[] = [
  {
    ...
    es: 'El gear viene en 4 rarezas y puede mejorarse hasta +10 (o +15 con Ascensión de Singularidad).',
  },
  {
    ...
    es: 'Las Armas y Accesorios Legendarios tienen restricciones de clase (por ejemplo, solo utilizables por Magos).',
  },
  {
    ...
    es: 'Las Armaduras otorgan bonos de conjunto cuando se equipan juntas.',
  },
  {
    ...
    es: 'El gear puede reforjarse para añadir sub-stats (hasta 4 en total) o mejorar los existentes si ya tiene 4.',
  },
  {
    ...
    es: 'El Breakthrough aumenta la main stat en un 5% por nivel (hasta T4) y mejora los efectos de skill/conjunto.',
  },
  {
    ...
    es: 'Las main stats no pueden rerollearse.',
  },
  {
    ...
    es: 'Las sub-stats pueden rerollearse usando las opciones de Cambio de Estadística.',
  },
];
