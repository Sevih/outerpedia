/**
 * Page PUBLIQUE de contribution aux SYNERGIES d'un perso (Jaego). Prod, sans
...
export async function generateMetadata({
  ...
  await params;
  return {
    title: 'Contribution — Synergies',
    robots: { index: false, follow: false },
  };
}

export default async function ContributeSynergiesPage({
  params,
}: {
  params: Promise<{ lang: string }>;
}) {
