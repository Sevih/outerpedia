 ...
 * (l'outil mesure la méta COURANTE, règle conservée), à la racine sinon. Chaque
 ...
 * convention STRUCTURELLE et non par famille : partout dans les contenus,
 ...
 * l'ancien pipeline en avait 4) et suit d'elle-même l'ajout d'une section.
 */
 ...
 * committé comme avant — même régime que le reste de l'éditorial, la page ISR
