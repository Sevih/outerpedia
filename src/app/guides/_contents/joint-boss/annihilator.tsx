    ...
    content: (
      <>
        ...
        <ul className="list-disc list-inside text-neutral-300 mb-4">
          ...
          <li><strong>Passive</strong>: Right after all attacks, does not trigger <EffectInlineTag name="BT_RUN_PASSIVE_SKILL_ON_TURN_END_DEFENDER_NO_CHECK" type="buff" />, <EffectInlineTag name="SYS_BUFF_REVENGE" type="buff" /> and <EffectInlineTag name="BT_STAT|ST_COUNTER_RATE" type="buff" />.</li>
