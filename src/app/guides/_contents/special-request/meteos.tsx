...
export default function MeteosGuide() {
  return (
    <GuideTemplate
      title="Meteos Strategy Guide"
      introduction="The gimmick of this boss is mainly related to the Barrier buff. He has a special gauge that triggers an AoE counter every 5 actions, and he does more damage if he has debuffs. Healers are useless as he blocks healing effects. He does significantly less damage to units protected by Barrier, even during Enrage."
