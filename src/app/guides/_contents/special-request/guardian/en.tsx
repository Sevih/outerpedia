...
export default function MasterlessGuide() {
    return (
        <GuideTemplate
            ...
            introduction="This boss is all about applying debuffs and managing his minions. When he has no debuffs, his weakness gauge cannot be reduced. Can be cleared in 1-2 attempts per stage with proper debuff management."
                ...
                default: {
                    ...
                    content: (
                        <>
                            ...
                            <TacticalTips tips={[
                                "All three boss skills remove 2 debuffs and decrease Ultimate cooldown. Reapply debuffs constantly.",
                                "When boss has zero debuffs, weakness gauge cannot be reduced and Ultimate damage is massively increased.",
                                "Boss spawns minions with S1 and S2. Each minion that moves gives boss 20% Action Gauge.",
                            ...
                            <hr className="my-6 border-neutral-700" />
                            <CombatFootage videoId="jAJOiJgASCU" title="Masterless Guardian Combat Footage" author="Community" date="01/01/2024" />
                        </>
                    ),
                },
            }}
