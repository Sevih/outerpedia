...
export default function TyrantGuide() {
    return (
        <GuideTemplate
            ...
            introduction="Tyrant Toddler is focused on cleansing debuffs quickly. Upon entering battle, you will be instantly stacked with {D/BT_DOT_POISON}, {D/BT_DOT_BLEED}, and {D/BT_DOT_LIGHTNING} that will kill you very quickly if not cleansed immediately. Units with AoE cleansing are essential."
                    ...
                    content: (
                        <>
                            ...
                            <TacticalTips tips={[
                                ...
                                "Viella and Dianne's S3 completely trivializes this boss by cleansing the full duration of all debuffs.",
                            ...
                            <hr className="my-6 border-neutral-700" />
                            <CombatFootage videoId="n9-IcrXHyBA" title="Tyrant Combat Footage" author="Sevih" date="09/05/2025" />
                        </>
                    ),
                },
            }}
