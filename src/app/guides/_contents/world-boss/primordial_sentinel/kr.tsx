                                ...
                                sections={[
                                    {
                                        title: "phase1",
                                        tips: [
                                            "행동 순서 증가와 감소를 최대한 활용하여 턴 수를 극대화하세요.",
                                            ...
                                            "페이즈 1에서 쌓은 체인 포인트를 유지하는 방법은 2가지입니다 — 아래 전환 섹션을 참고하세요."
                                        ]
                                    },
                                    {
                                        title: { en: "Phase Transition", jp: "フェーズ移行", kr: "페이즈 전환", zh: "阶段过渡" },
                                        tips: [
                                            "6성 {P/Monad Eva}가 있는 경우: 그녀의 존재만으로 보스에게 {D/BT_SEAL_ADDITIVE_ATTACK}가 적용되어 모든 CP를 빼앗는 추가 공격을 방지합니다. 팀 2로의 교체는 전환 전(가장 안전) 또는 전환 후에 할 수 있지만, 전환 후에 교체하려면 보스보다 먼저 행동할 수 있을 만큼 빨라야 합니다 ({AS/Swiftness} 또는 행동 순서 증가 권장).",
                                            "{P/Monad Eva} 6성이 없는 경우: 팀 2에 {E/Fire}, {E/Water}, {E/Earth} 속성 캐릭터를 최소 1명 편성하세요.",
                                            "페이즈 2 전환 기준(120만 데미지) 근처에서 팀 2로 교체하세요. 보스가 행동하게 한 후 페이즈 2로 진입시킵니다. 보스가 다시 행동하여 {B/CORE_ENERGY} 버프를 얻으면, 다음 턴 전에 브레이크하여 버프를 제거하고 CP를 빼앗는 추가 공격을 방지하세요."
                                        ]
                                    }
                                ]}
                            />
