                                ...
                                sections={[
                                    {
                                        ...
                                        tips: [
                                            ...
                                            "フェーズ1で貯めたチェーンポイントを維持する方法は2つあります — 下の移行セクションを参照してください。"
                                        ]
                                    },
                                    {
                                        title: { en: "Phase Transition", jp: "フェーズ移行", kr: "페이즈 전환", zh: "阶段过渡" },
                                        tips: [
                                            "6凸の{P/Monad Eva}がいる場合：彼女がいるだけでボスに{D/BT_SEAL_ADDITIVE_ATTACK}が付与され、CPを全て奪う追加攻撃を防げます。チーム2への切り替えは移行前（最も安全）でも移行後でも可能ですが、移行後に切り替える場合はボスより先に行動できる速度が必要です（{AS/Swiftness}や行動順アップ推奨）。",
                                            "{P/Monad Eva}6凸なしの場合：チーム2に{E/Fire}・{E/Water}・{E/Earth}属性のキャラクターを最低1人入れてください。",
                                            "フェーズ2の閾値（120万ダメージ）付近でチーム2に切り替えます。ボスに行動させ、フェーズ2に移行させます。ボスが再行動して{B/CORE_ENERGY}バフを得たら、次のターン前にブレイクしてバフを解除し、CPを奪う追加攻撃を防ぎましょう。"
                                        ]
                                    }
                                ]}
                            />
