...
const PrimordialSentinelTeams = PrimordialSentinelTeamsData as Record<
  string,
  TeamData
>;
      ...
      versions={{
        march2026: {
          ...
          content: (
            <>
              <WorldBossDisplay
                config={primordialSentinelNovember2025}
                defaultMode="Extreme"
              />
              ...
              <RecommendedCharacterList
                title="phase1"
                entries={phase1Characters03}
              />
              <RecommendedCharacterList
                title="phase2"
                entries={phase2Characters03}
              />
              <hr className="my-6 border-neutral-700" />
              <StageBasedTeamSelector
                teamData={PrimordialSentinelTeams.march2026}
                defaultStage="Phase 1"
              />
              <hr className="my-6 border-neutral-700" />
              <CombatFootage
                videoId="2eeYmkacaqA"
        ...
        november2025: {
          ...
          content: (
            <>
              ...
              <RecommendedCharacterList
                title="phase1"
                entries={phase1Characters}
              />
              <RecommendedCharacterList
                title="phase2"
                entries={phase2Characters}
              />
              <hr className="my-6 border-neutral-700" />
              <StageBasedTeamSelector
                teamData={PrimordialSentinelTeams.november2025}
                defaultStage="Phase 1"
              />
              <hr className="my-6 border-neutral-700" />
              <CombatFootage
              ...
              <p className="mt-2 text-neutral-400 text-sm">
                Note: This video showcases an SSS Extreme clear. The same
                strategy can be applied to lower difficulties, but certain boss
                mechanics may be weakened or disabled. As the score is not
                unlimited before Extreme League, this requires less focus on
                building chain points in phase 1.
              </p>
            </>
          ),
        },
          ...
          content: (
            <>
              ...
              <p className="text-neutral-300 mb-4">
                This comp only works with 6-star {"{P/Monad Eva}"}. Credit to{" "}
                <strong>Birdmouth</strong> for discovering this. The core energy
                buff counts as an additional attack, which {"{P/Monad Eva}"}{" "}
                skill seal at battle start can cancel. This protects your CP
                from being lost.
              </p>
              <p className="text-neutral-300 mb-4">
                Alternative: swap to Team 2 during Phase 1. Since {"{E/Light}"}{" "}
                {"{E/Dark}"} units can&apos;t reduce WG in P1, you&apos;ll need
                at least one {"{E/Fire}"} {"{E/Water}"} {"{E/Earth}"} unit in
                Team 2. This lets {"{P/Monad Eva}"} apply skill seal upon
                entering P2 and protect your rotation.
              </p>
              <p className="text-neutral-300">
                Another option: run {"{P/Demiurge Stella}"} instead of{" "}
                {"{P/Stella}"}. Swap to Team 2 at end of P1 and use one chain
                skill to trigger fixed damage and move into P2.
              </p>
              <hr className="my-6 border-neutral-700" />
              <CombatFootage
                videoId="Kd-dKroOXEo"
