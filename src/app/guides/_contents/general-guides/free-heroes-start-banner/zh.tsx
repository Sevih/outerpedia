    ...
    return (
        <div className="guide-content">
            ...
            <p className="text-red-500 font-semibold bg-red-100 border border-red-300 rounded px-4 py-2 text-sm mb-6">
                避免重复选择 — <strong>始终选择你尚未拥有的角色</strong>。如果游戏内推荐看起来不同，是因为我们已经排除了从确定来源（任务、故事进度）获得的英雄。
            </p>
    ...
    return (
        <div className="space-y-6">
            <p className="text-neutral-400 text-sm italic">
                公会商店英雄需要5周以上才能解锁。优先从自选池获取以便早期推进，然后使用公会商店进行超越。
            </p>
    ...
    return (
        <div className="space-y-6">
            ...
            <table className="w-auto mx-auto border border-gray-600 rounded-md text-center border-collapse">
                <thead>
                    <tr className="border-b-2 border-slate-500">
                        <th className="text-center py-3 px-4 text-sky-400 font-semibold border-r border-slate-600">推荐</th>
                        <th className="text-center py-3 px-4 text-sky-400 font-semibold border-r border-slate-600">免费获取</th>
                        <th className="text-center py-3 px-4 text-sky-400 font-semibold">详情</th>
                    </tr>
                </thead>
                <tbody>
