              ...
              < section className="space-y-6">
                ...
                <div className="space-y-6">
                  <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/30 border border-slate-700 rounded-xl p-6 space-y-3">
                    ...
                    <p className=" leading-relaxed">
                      Eva&apos;s Guide Quests and Skyward Tower will sort this out while levelling, along with the Challenge! Special Request missions&apos; 6-star legendary gear. When enough Survey Hub or Arena currency is available, these can also offer solid 6-star gear.
