export const recommendedCharacters = [
    {
        ...
        reason: {
            ...
            kr: "뛰어난 단일 대상 딜을 가진 강력한 {E/Fire} DPS.",
            zh: "拥有出色单体伤害的强力{E/Fire}DPS。"
        }
    },
    {
        ...
        reason: {
            ...
            kr: "딜을 하면서 팀을 유지할 수 있는 {E/Fire} 서포터.",
            zh: "能在输出伤害的同时维持队伍的{E/Fire}辅助。"
        }
    },
    {
        names: ["Tio", "Astei"],
    ...
    },
    {
        ...
        reason: {
            ...
            kr: "{D/BT_DOT_BURN} 전략을 위한 대체 DPS.",
            zh: "{D/BT_DOT_BURN}策略的替代DPS。"
        }
    }
]
