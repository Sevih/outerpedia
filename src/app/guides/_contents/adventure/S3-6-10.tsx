    ...
    return (
        <div>
            ...
            <ul className="list-disc list-inside text-neutral-300 mb-4">
                ...
                <li><strong>S3</strong>: AoE, <EffectInlineTag name="BT_IMMEDIATELY_2000092" type="debuff" /> all <EffectInlineTag name="BT_DOT_CURSE" type="debuff" />. If target&apos;s HP &lt; 70%, inflict <EffectInlineTag name="BT_FREEZE" type="debuff" /> (ignore immunity)</li>
                <li><strong>Passive</strong>: When attacking while granted <EffectInlineTag name="BT_STAT|ST_BUFF_CHANCE" type="buff" />, inflict <EffectInlineTag name="IG_Buff_Dot_Curse_Interruption_D" type="debuff" /> 9 turns (ignore immunity).</li>
