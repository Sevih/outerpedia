                    ...
                    content: (
                        <>
                            ...
                            <TacticalTips tips={[
                                ...
                                "S2/S3 공격 전에 버프를 준비하여 {D/BT_DOT_BURN_IR}를 방지하세요",
                                "모든 체인 어택을 개시하고 브레이크하기 전에 {D/BT_FREEZE}를 적용하세요",
                                "팀의 속도를 조정하여 체인 어택 시작 전에 모든 유닛이 100% 우선도에 도달하도록 하세요. 이렇게 하면 피격으로 행동 게이지를 얻더라도 보스가 끼어들지 못합니다 (피격당 25% 획득)",
                                "{I-T/Sage's Charm} +10은 체인의 마지막 유닛이 착용하면 체인 어택 피해를 50% 증가시킵니다",
