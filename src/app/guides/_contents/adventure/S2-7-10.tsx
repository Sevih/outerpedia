    ...
    return (
        <div>
            ...
            <ul className="list-disc list-inside text-neutral-300 mb-4">
                <li><strong>S1</strong>: Single, inflict <EffectInlineTag name="IG_Buff_Dot_Burn_Interruption_D" type="debuff" /> 2 turns.</li>
                <li><strong>S2</strong>: AoE, inflict <EffectInlineTag name="IG_Buff_Dot_Burn_Interruption_D" type="debuff" /> 2 turns.</li>
                <li><strong>S3</strong>: AoE, <EffectInlineTag name="BT_IMMEDIATELY_2000092" type="debuff" /> all <EffectInlineTag name="IG_Buff_Dot_Burn_Interruption_D" type="debuff" /> <EffectInlineTag name="BT_DOT_BURN" type="debuff" /> debuffs.</li>
                <li><strong>Passive</strong>: Gains permanent <EffectInlineTag name="BT_SYS_BUFF_ENHANCE_IR" type="buff" />.</li>
                <li><strong>Passive</strong>: Does not take weakness gauge damage from <EffectInlineTag name="IG_Buff_Dot_Burn_Interruption_D" type="debuff" /> <EffectInlineTag name="BT_DOT_BURN" type="debuff" /> enemies.</li>
