...
export default function BannerTabCards({
  ...
  className={`relative group overflow-visible transition-all duration-300 w-full rounded-[12px] ${
    isActive
      ? 'ring-2 ring-yellow-400 ring-offset-black shadow-[0_0_8px_rgba(255,215,0,0.6)]'
      : 'ring-2 ring-transparent hover:ring-yellow-100'
  }`}
>
  <div className="relative w-full aspect-[3.66/1] rounded-[12px] overflow-hidden">
    <Image
