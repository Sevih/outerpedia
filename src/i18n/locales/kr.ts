...
const kr: Record<TranslationKey, string> = {
  ...
  'changelog.type.character': '캐릭터',
  'changelog.type.news': '소식',
  'changelog.type.fix': '수정',
  'changelog.goto.character': '캐릭터 보기',
  'changelog.goto.guide': '가이드 보기',
  'changelog.goto.tool': '도구 열기',
  'changelog.goto.page': '자세히 보기',
  ...
  'equip.filter.class': '클래스',
  'equip.filter.element': '속성',
  'equip.ee.unlock': '해방',
  'equip.ee.upgrade': '강화',
  'equip.filter.search': '이름으로 검색...',
  'equip.detail.configure': '설정',
  'equip.detail.enhancement': '강화',
  'equip.detail.breakthrough': '한계 돌파',
  'equip.detail.reforge': '재련',
  'equip.detail.available': '회 가능',
  'equip.detail.ascend': '승화',
  'equip.detail.ascended': '승화됨',
  'equip.detail.needs10': '+10 필요',
  'equip.detail.substats': '부가 스탯',
  'equip.detail.effect': '효과',
  'equip.detail.ascension': '특이점 승화',
  'equip.detail.bonus15': '보너스 효과 · +15 해금',
  'equip.detail.priority': '우선순위',
  ...
  'tierlist.disclaimer_pvp':
    '이 티어 리스트는 6성 초월과 레벨 10 전용 장비 효과를 전제로 합니다. 강화가 해제되지 않은 경우 결과가 다를 수 있습니다. PvP 콘텐츠 전용입니다.',
  'tierlist.disclaimer_ee_base':
    '이 랭킹은 각 전용 장비의 기본 레벨(Lv0) 해제 우선순위를 반영합니다. 강화 효과는 고려되지 않았습니다.',
  ...
  'tools.gear-usage-finder.mode_reco.desc':
    '빌드 추천에 있는 스탯과 장비만 표시합니다. 메인 스탯으로 엄격하게 필터링합니다.',
  ...
  'tools.hero-tracker.untrack': '기록 해제',
  'tools.hero-tracker.level': '레벨',
  'tools.hero-tracker.skills': '스킬',
  'tools.hero-tracker.fusionLevel': '퓨전 레벨',
  'tools.hero-tracker.affinity': '호감도',
  'tools.hero-tracker.transcend': '초월',
  'tools.hero-tracker.ee': '전용 장비',
  'tools.hero-tracker.eeFusion': '퓨전 전용 장비',
  'tools.hero-tracker.needTitle': '필요 재료',
  'tools.hero-tracker.needEmpty': '남은 것이 없습니다 — 영웅을 기록하거나 목표를 높여 보세요.',
  'tools.hero-tracker.gold': '골드',
  'tools.hero-tracker.xp': '영웅 경험치',
  'tools.hero-tracker.affinityPoints': '호감도 포인트',
  'tools.hero-tracker.pieces': '영웅 조각',
  'tools.hero-tracker.dupes': '또는 중복 {count}개',
  'tools.hero-tracker.giftNoteBonus': '선물 개수는 선호 선물 기준입니다(호감도 +50%).',
  'tools.hero-tracker.reset': '초기화',
  'tools.hero-tracker.resetConfirm': '기록 중인 영웅을 모두 삭제할까요?',
  'tools.hero-tracker.trackedCount': '{count}명 기록 중',
  'tools.hero-tracker.shoppingList': '필요 재료 목록',
  'tools.hero-tracker.myHeroes': '내 영웅',
  'tools.hero-tracker.addHero': '영웅 추가',
  'tools.hero-tracker.untracked': '미기록 {count}명',
  'tools.hero-tracker.heroNeeds': '이 영웅에게 필요한 재료',
  'tools.hero-tracker.doneHero': '완료 — 남은 재료 없음',
  'tools.hero-tracker.emptyTitle': '기록 중인 영웅이 없습니다',
  'tools.hero-tracker.emptyCta': '영웅 고르기',
  'tools.hero-tracker.itemCount': '{count}개',
  ...
  'tools.hero-tracker.noMatch': '이 필터에 맞는 추적 중인 영웅이 없습니다.',
  'tools.hero-tracker.piecesPremium': '프리미엄',
  'tools.hero-tracker.piecesLimited': '한정',
  ...
  'tools.hero-tracker.rarityRules': '낮은 등급 영웅',
  'tools.hero-tracker.hideShort': '숨기기',
  'tools.hero-tracker.skipShort': '합산 제외',
  ...
  'tools.tier-list-maker.export_blocked':
    '브라우저가 이미지 내보내기를 차단했습니다. 개인정보/핑거프린트 방지 설정이나 그래픽 드라이버 문제일 수 있습니다. 다른 브라우저를 사용하거나 이 사이트의 canvas를 허용하세요.',
  ...
  'tools.damage-calculator.settings.guild': '길드 버프',
  'tools.damage-calculator.settings.premium': '칭호 버프 [고급보디]',
  ...
  'tools.damage-calculator.team.ee_owned': '전용 장비 보유',
  'tools.damage-calculator.team.ee_plus10': '전용 장비 +10',
  ...
  'tools.damage-calculator.buffs.boss_passive': '보스 패시브',
  // Common UI strings
  ...
  'tools.damage-calculator.target.guild_buff_flag': '길드 버프 적용',
  'tools.damage-calculator.target.title_buff_flag': '칭호 버프 적용',
  'tools.damage-calculator.target.enrage_flag': '격노 상태',
  // 조건의 읽기 쉬운 라벨 (원본 enum은 툴팁에 남음)
  'tools.damage-calculator.context.cond.owner_resource': '고유 자원 조건',
  'tools.damage-calculator.context.cond.owner_has_buff': '자신에게 버프 있음',
  'tools.damage-calculator.context.cond.owner_has_all_buff': '자신에게 모든 버프 있음',
  'tools.damage-calculator.context.cond.owner_has_not_buff': '자신에게 버프 없음',
  'tools.damage-calculator.context.cond.owner_alone': '혼자 생존 중',
  'tools.damage-calculator.context.cond.owner_together': '아군 생존 중',
  'tools.damage-calculator.context.cond.owner_run_counter': '행동 횟수 조건',
  'tools.damage-calculator.context.cond.caster_has_buff': '시전자에게 버프 있음',
  'tools.damage-calculator.context.cond.caster_has_not_buff': '시전자에게 버프 없음',
  'tools.damage-calculator.context.cond.caster_enemy_team_has_buff': '적 팀에게 버프 있음',
  ...
  'tools.damage-calculator.attacker.skill_levels': '스킬 레벨',
  'tools.damage-calculator.attacker.tag_dmg': 'DMG',
  'tools.damage-calculator.equipment.sets': '세트 효과',
  'tools.damage-calculator.stats.sheet_note': '게임 캐릭터 시트 그대로',
  'tools.damage-calculator.stats.final': '최종 스탯',
  'tools.damage-calculator.stats.final_note': '계산값 · 읽기 전용',
  'tools.damage-calculator.target.spawn_adv': '스폰 +{pct}% ATK/DEF',
  'tools.damage-calculator.context.title': '컨텍스트',
  ...
  'guides.difficulty.league_1': '노멀 리그',
  'guides.difficulty.league_2': '하드 리그',
  'guides.difficulty.league_3': '베리 하드 리그',
  'guides.difficulty.league_4': '익스트림 리그',
  'guides.difficulty.tips_for': '아래 공략과 팀 구성은 {difficulty} 기준입니다.',
  ...
  'home.discord.description': '팀 편성 공유, 질문, 공략 토론을 커뮤니티와 함께하세요.',
  ...
  'legal.p3':
    'Outerpedia는 게임 파일을 호스팅하거나 재배포하지 않습니다. 모든 시각적 자산은 해설 및 문서화 목적으로만 표시됩니다. 콘텐츠의 다운로드나 재사용은 불가합니다.',
  'legal.p4':
    '본 사이트에 게시된 콘텐츠의 정당한 소유자이며 삭제를 원하시는 경우, 당사 또는 호스팅 제공업체에 직접 연락해 주시기 바랍니다. 삭제 요청에 신속히 대응하겠습니다.',
  'legal.hosting': '호스팅 제공업체',
  'legal.p5':
    '본 사이트는 개인이 운영합니다. 프랑스 법(LCEN)에 따라 호스팅 제공업체를 통해 법적 요청 시 사법 당국에 신원 정보를 공개할 수 있습니다.',
  ...
  'page.character.skill.priority_rule_chain':
    '체인 패시브는 나중까지 레벨 2로 두어도 됩니다. 레벨 5의 약점 게이지 데미지 증가만 중요하므로, 더 중요한 스킬이 완료될 때까지 스킬 교본을 아낄 수 있습니다.',
  ...
  'page.character.gear.verdict.title': '고정값 vs %',
  'page.character.gear.verdict.hint':
    '아래 육성 상태에서 이 영웅의 6★ 장비 공격/방어/체력 부옵은 어느 쪽이 리포지 1틱당 더 이득인지 — 착용 장비와 버프는 결과에 영향이 없습니다.',
  'page.character.gear.verdict.badge_flat': '고정',
  'page.character.gear.verdict.level': '레벨',
  'page.character.gear.verdict.tip_base':
    'Lv.{level} 기본값: {base} (스탯 + 진화{awak} — 장비·초월·버프 제외)',
  'page.character.gear.verdict.tip_awak': ' + 기아스',
  'page.character.gear.verdict.tip_flat': '고정 틱: +{flat}',
  'page.character.gear.verdict.tip_pct': '% 틱: +{pct}% × {base} = +{equiv}',
  'page.character.gear.verdict.tip_breakeven': '기본값 {value} 이상이면 %가 유리',
  'page.character.gear.verdict.tip_pct_wins': '%가 틱당 더 많이 오릅니다',
  'page.character.gear.verdict.tip_flat_wins': '고정값이 틱당 더 많이 오릅니다',
  'page.character.gear.verdict.tip_close': '차이가 {margin}% 미만 — 둘 다 무방',
  ...
  'progress.clearDataDesc':
    '설정을 포함한 모든 진행 상황 데이터를 삭제합니다. 문제가 발생할 경우 사용하세요.',
