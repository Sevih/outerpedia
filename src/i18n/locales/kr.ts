...
const kr: Record<TranslationKey, string> = {
  ...
  'tools.damage-calculator.attacker.tier_label': '초월 레벨',
  ...
  'tools.damage-calculator.equipment.add_set': '+ 세트 추가',
  ...
  'tools.damage-calculator.target.monster': '몬스터',
  'tools.damage-calculator.target.resolved': '적용값',
  'tools.damage-calculator.target.hp_bars': 'HP {n}줄',
  'tools.damage-calculator.target.spawn_adv': '스폰 +{pct}% ATK/DEF',
  'tools.damage-calculator.context.title': '컨텍스트',
  'tools.damage-calculator.context.content_type': '콘텐츠 유형',
  'tools.damage-calculator.context.type_pve': 'PvE',
  'tools.damage-calculator.context.type_arena': '아레나',
  'tools.damage-calculator.context.type_rtpvp': '실시간 PvP',
  'tools.damage-calculator.context.targets_hit': '대상 수',
  'tools.damage-calculator.context.penalty_cycle': '페널티 사이클',
  'tools.damage-calculator.context.penalty_note': '10턴부터 PvP 페널티 — 양측 모두 적용됩니다.',
  'tools.damage-calculator.buffs.from_kits': '+ 킷에서',
  'tools.damage-calculator.buffs.kits_soon': '킷 버프 데이터 필요 — 엔진과 함께 제공',
  'tools.damage-calculator.buffs.on_attacker': '공격자에게',
  'tools.damage-calculator.buffs.on_target': '대상에게',
  'tools.damage-calculator.buffs.value': '수치',
  'tools.damage-calculator.buffs.stacks': '스택',
  'tools.damage-calculator.report.engine_wip':
    '계산 엔진은 아직 연결되지 않았습니다 — 최종 레이아웃을 임시 값으로 표시합니다.',
  ...
  'tools.damage-calculator.report.expected': '기대 피해량',
  'tools.damage-calculator.report.expected_note': '모든 분기의 가중 평균',
