...
const kr: Record<TranslationKey, string> = {
  ...
  'tools.tier-list-maker.tag.festival': '페스티벌',
  ...
  'characters.filters.tag_group.limited': '한정 유닛',
  ...
  'page.character.gear.verdict.badge_even': '동등',
  'page.character.gear.verdict.level': '레벨',
  'page.character.gear.verdict.calc_line': '+{pct}% × {base} = +{equiv} vs 고정 +{flat}',
  'page.character.gear.verdict.calc_note':
    '6★ 장비 리포지 1틱 기준. Lv.{level} 기본값 = 스탯 + 진화{awak} — 착용 장비·초월·버프는 결과에 영향이 없습니다.',
  'page.character.gear.verdict.calc_breakeven': '기본값이 {list} 이상이면 %가 유리합니다.',
  'page.character.gear.verdict.calc_awak': ' + 기아스',
  'page.character.gear.verdict.pct_wins': '%가 틱당 더 많이 오릅니다',
  'page.character.gear.verdict.flat_wins': '고정값이 틱당 더 많이 오릅니다',
  'page.character.gear.verdict.close': '차이가 {margin}% 미만 — 둘 다 무방',
