...
const kr: Record<TranslationKey, string> = {
  ...
  'coupons.redeem.disclaimer':
    '쿠폰은 Outerplane 공식 쿠폰 서비스로 직접 전송됩니다. Outerpedia는 아무것도 저장하지 않습니다.',
  'coupons.redeem.result.success':
    '쿠폰을 정상적으로 적용했습니다! 게임 내 우편함에서 보상을 받으세요.',
  ...
  'page.character.core_fusion.skill_info':
    '코어 융합 해금에는 {material} {unlockCost}개가 필요합니다 (스킬 Lv.1부터 시작). 스킬 레벨 강화에는 {material} {upgradeCost}개를 소모하며, 모든 스킬 레벨이 1 상승합니다. 총: {totalCost}개의 {material}로 전체 최대화.',
