...
const en = {
  ...
  'equip.detail.available': 'available',
  'equip.detail.ascend': 'Ascend',
  'equip.detail.ascended': 'Ascended',
  'equip.detail.needs10': 'needs +10',
  'equip.detail.substats': 'Substats',
  'equip.detail.effect': 'Effect',
  'equip.detail.ascension': 'Singularity Ascension',
  'equip.detail.bonus15': 'Bonus effect · unlocked at +15',
  'equip.detail.priority': 'Priority',
  ...
  'tierlist.disclaimer_pvp':
    'This tier list assumes 6-star transcends and level 10 Exclusive Equipment effects. Results may vary if upgrades are not unlocked. This list is for PvP content only.',
  'tierlist.disclaimer_ee_base':
    'This ranking reflects the priority of unlocking each Exclusive Equipment at base level (Lv0). It does not account for upgraded effects.',
  'tierlist.disclaimer_ee_plus10':
    'This ranking reflects the priority of upgrading each Exclusive Equipment to +10.',
  ...
  'tools.gear-usage-finder.mode_reco.desc':
    'Only shows stats and items that appear in build recommendations. Strict main stat filtering.',
  ...
  'tools.patch-history.zh_fallback':
    'This content is displayed in English as it is not available in Chinese.',
  ...
  'tools.hero-tracker.untrack': 'Untrack',
  'tools.hero-tracker.level': 'Level',
  'tools.hero-tracker.skills': 'Skills',
  'tools.hero-tracker.fusionLevel': 'Fusion level',
  'tools.hero-tracker.affinity': 'Affinity',
  'tools.hero-tracker.transcend': 'Transcendence',
  'tools.hero-tracker.ee': 'Exclusive Equipment',
  'tools.hero-tracker.eeFusion': 'Fusion EE',
  'tools.hero-tracker.needTitle': 'Materials needed',
  'tools.hero-tracker.needEmpty': 'Nothing left — track a hero or raise a target.',
  'tools.hero-tracker.gold': 'Gold',
  'tools.hero-tracker.xp': 'Hero EXP',
  ...
  'tools.hero-tracker.resetConfirm': 'Clear every tracked hero?',
  'tools.hero-tracker.trackedCount': '{count} tracked',
  'tools.hero-tracker.shoppingList': 'Shopping list',
  'tools.hero-tracker.myHeroes': 'My heroes',
  'tools.hero-tracker.addHero': 'Add a hero',
  'tools.hero-tracker.untracked': '{count} not tracked',
  'tools.hero-tracker.heroNeeds': 'Needed for this hero',
  'tools.hero-tracker.doneHero': 'Done — nothing to farm',
  'tools.hero-tracker.emptyTitle': 'No hero tracked yet',
  'tools.hero-tracker.emptyCta': 'Pick my heroes',
  'tools.hero-tracker.itemCount': '{count} items',
  ...
  'tools.hero-tracker.noMatch': 'No tracked hero matches these filters.',
  'tools.hero-tracker.piecesPremium': 'Premium',
  'tools.hero-tracker.piecesLimited': 'Limited',
  ...
  'tools.hero-tracker.settingsFusionHint':
    'A Core Fusion replaces its base hero — you never own both. Pick the one on your account.',
  ...
  'tools.hero-tracker.rarityRules': 'Low-rarity heroes',
  'tools.hero-tracker.hideShort': 'Hide',
  'tools.hero-tracker.skipShort': 'Not in totals',
  ...
  'tools.team-planner.wip':
    'This tool is under development. Some features may be incomplete or change.',
  ...
  'tools.tier-list-maker.export_blocked':
    'Your browser blocked the image export — likely a privacy / anti-fingerprinting setting or a graphics-driver issue. Try another browser, or allow canvas for this site.',
  ...
  'tools.damage-calculator.settings.guild': 'Guild Buff',
  'tools.damage-calculator.settings.premium': 'Title Buff [Premium Body]',
  ...
  'tools.damage-calculator.team.ee_owned': 'EE owned',
  ...
  'tools.damage-calculator.obs.no_baseline_hint':
    'Saved before `calculatedAtSave` was added to the admin schema — re-save in admin to backfill.',
  // Share panel — export / import calc state
  'tools.damage-calculator.share.title': 'Share',
  'tools.damage-calculator.share.subtitle':
    'Export your full setup so someone else can reproduce it, or paste a share to load theirs.',
  ...
  'tools.damage-calculator.share.copy_fallback':
    'Clipboard blocked — text selected, press Ctrl+C to copy.',
  ...
  'tools.damage-calculator.share.report_note_placeholder':
    'Context, repro steps, anything that helps debug…',
  ...
  'tools.damage-calculator.buffs.boss_passive': 'Boss passive',
  // Common UI strings
  ...
  'tools.damage-calculator.target.guild_buff_flag': 'Guild Buff active',
  'tools.damage-calculator.target.title_buff_flag': 'Title Buff active',
  'tools.damage-calculator.target.enrage_flag': 'Enraged',
  // Readable condition labels (raw enum stays in tooltips)
  'tools.damage-calculator.context.cond.owner_resource': 'Unique resource condition',
  'tools.damage-calculator.context.cond.owner_has_buff': 'Self has a buff',
  'tools.damage-calculator.context.cond.owner_has_all_buff': 'Self has all the buffs',
  'tools.damage-calculator.context.cond.owner_has_not_buff': 'Self has no buff',
  'tools.damage-calculator.context.cond.owner_alone': 'Alone on the battlefield',
  'tools.damage-calculator.context.cond.owner_together': 'With allies on the battlefield',
  'tools.damage-calculator.context.cond.owner_run_counter': 'Action count condition',
  'tools.damage-calculator.context.cond.caster_has_buff': 'Caster has a buff',
  'tools.damage-calculator.context.cond.caster_has_not_buff': 'Caster has no buff',
  'tools.damage-calculator.context.cond.caster_enemy_team_has_buff': 'Enemy team has a buff',
  ...
  'tools.damage-calculator.context.cond.attacker_element_win':
    'Attacker has the elemental advantage',
  ...
  'tools.damage-calculator.equipment.ee_conditional_hint':
    'Fires under runtime conditions (target/owner buffs, kill streak, etc.) — verify in-game',
  ...
  'tools.damage-calculator.equipment.4pc_hint':
    'Already in the other slot — pick again to unlock 4-pc',
  ...
  'legal.p3':
    'Outerpedia does not host or redistribute game files. All visual assets are displayed for commentary and documentation purposes only. No content is made available for download or reuse.',
  'legal.p4':
    'If you are the rightful owner of any content featured on this site and would like it removed, you may contact us or our hosting provider directly. We will respond to any takedown request promptly.',
  ...
  'sys.class.passive.striker':
    'Generates 5 Action Points at the start of turn. Generates 20 Action Points when attacking. Increases Critical Hit Chance by 5%.',
  'sys.class.passive.defender':
    'Generates 5 Action Points at the start of turn. Generates 35 Action Points when hit. Increases Defense by 15%.',
  'sys.class.passive.ranger': 'Generates 20 Action Points at the start of turn.',
  'sys.class.passive.healer':
    'Generates 5 Action Points at the start of turn. Generates 25 Action Points when an ally is hit. Increases Health by 10%.',
  'sys.class.passive.mage':
    'Generates 5 Action Points at the start of turn. Generates Action Points when using skills. Increases Attack by 10%.',
  ...
  'sys.subclass.info.bruiser':
    'A brawler who specializes in prolonged battles with balanced offensive and defensive skills.',
  'sys.subclass.info.wizard':
    'A master of magic who wreaks havoc on the battlefield with powerful spells.',
  'sys.subclass.info.enchanter':
    'A mastermind in battles who weakens enemies with a variety of additional effects.',
  'sys.subclass.info.vanguard': 'A leader who dominates the enemy with high Speed.',
  'sys.subclass.info.tactician':
    'A master strategist who gets the upper hand in battles by granting buffs to allies.',
  'sys.subclass.info.sweeper': 'A combat specialist who waits patiently for an opening.',
  'sys.subclass.info.phalanx':
    'A defensive specialist who stands their ground to protect their allies.',
  'sys.subclass.info.reliever': 'A savior who heals allies in moments of peril.',
  'sys.subclass.info.sage':
    "A support specialist who thwarts the enemy's attempts to hamper their allies by granting them various effects.",
  ...
  'page.character.gear.verdict.title': 'Flat or %?',
  'page.character.gear.verdict.hint':
    'Which version of ATK / DEF / HP gains more per reforge tick on 6★ gear for this hero, at the investment below — equipped gear and buffs do not change the answer.',
  'page.character.gear.verdict.badge_flat': 'flat',
  'page.character.gear.verdict.level': 'Level',
  'page.character.gear.verdict.tip_base':
    'Base at Lv.{level}: {base} (stats + evolutions{awak} — no gear, transcendence or buffs)',
  'page.character.gear.verdict.tip_awak': ' + quirks',
  'page.character.gear.verdict.tip_flat': 'Flat tick: +{flat}',
  'page.character.gear.verdict.tip_pct': '% tick: +{pct}% × {base} = +{equiv}',
  'page.character.gear.verdict.tip_breakeven': '% wins above {value} base',
  'page.character.gear.verdict.tip_pct_wins': '% gives more per tick',
  'page.character.gear.verdict.tip_flat_wins': 'Flat gives more per tick',
  'page.character.gear.verdict.tip_close': 'Within {margin}% of each other — either works',
  ...
  // ─── 4-Cut Comics ────────────────────────────────────────────────────────
  'comics.description':
    'Browse the official Outerplane 4-cut comics. Click on any image to view full size.',
  ...
  'progress.clearDataDesc':
    'This will clear all progress tracker data including settings. Use this if you encounter issues.',
