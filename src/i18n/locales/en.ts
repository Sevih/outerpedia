...
const en = {
  ...
  'characters.filters.tag_group.limited': 'Limited Units',
  ...
  'page.character.gear.verdict.badge_even': 'even',
  ...
  'page.character.gear.verdict.calc_note':
    'Per reforge tick on 6★ gear. Base at Lv.{level} = stats + evolutions{awak} — equipped gear, transcendence and buffs do not change the answer.',
  'page.character.gear.verdict.calc_breakeven': '% wins above {list}.',
  'page.character.gear.verdict.calc_awak': ' + quirks',
  'page.character.gear.verdict.pct_wins': '% gives more per tick',
  'page.character.gear.verdict.flat_wins': 'Flat gives more per tick',
  'page.character.gear.verdict.close': 'Within {margin}% of each other — either works',
