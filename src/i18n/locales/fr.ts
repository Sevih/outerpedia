...
const fr: Record<TranslationKey, string> = {
  ...
  'aria.star_count': '{n, plural, one {# étoile} other {# étoiles}}',
  'video.by': 'par {author}',
  ...
  'characters.filters.tag_group.limited': 'Unités Limitées',
  ...
  'page.character.gear.verdict.badge_even': 'égal',
  'page.character.gear.verdict.level': 'Niveau',
  'page.character.gear.verdict.calc_line': '+{pct} % × {base} = +{equiv} vs +{flat} flat',
  'page.character.gear.verdict.calc_note':
    "Par tick de reforge sur du gear 6★. Base au Nv.{level} = stats + évolutions{awak} — l'équipement porté, la transcendance et les buffs ne changent pas la réponse.",
  'page.character.gear.verdict.calc_breakeven': 'Le % gagne au-dessus de {list}.',
  'page.character.gear.verdict.calc_awak': ' + quirks',
  'page.character.gear.verdict.pct_wins': 'Le % rapporte plus par tick',
  'page.character.gear.verdict.flat_wins': 'Le flat rapporte plus par tick',
  'page.character.gear.verdict.close': "À moins de {margin} % l'un de l'autre — les deux se valent",
