...
const fr: Record<TranslationKey, string> = {
  ...
  'equip.filter.class': 'Classe',
  'equip.filter.element': 'Élément',
  'equip.ee.unlock': 'Déblocage',
  'equip.ee.upgrade': 'Amélioration',
  'equip.filter.search': 'Rechercher par nom...',
  'equip.detail.configure': 'Configurer',
  'equip.detail.enhancement': 'Amélioration',
  'equip.detail.breakthrough': 'Breakthrough',
  'equip.detail.reforge': 'Reforge',
  'equip.detail.available': 'disponibles',
  'equip.detail.ascend': 'Ascension',
  'equip.detail.ascended': 'Ascendé',
  'equip.detail.needs10': 'requiert +10',
  'equip.detail.substats': 'Substats',
  'equip.detail.effect': 'Effet',
  'equip.detail.ascension': 'Ascension Singularity',
  'equip.detail.bonus15': 'Effet bonus · débloqué au +15',
  'equip.detail.priority': 'Priorité',
  ...
  'tierlist.disclaimer_pvp':
    "Cette tier list suppose des transcendances 6 étoiles et des effets d'Exclusive Equipment de niveau 10. Les résultats peuvent varier si les améliorations ne sont pas débloquées. Cette liste concerne uniquement le contenu PvP.",
  'tierlist.disclaimer_ee_base':
    'Ce classement reflète la priorité de déblocage de chaque Exclusive Equipment au niveau de base (Lv0). Il ne prend pas en compte les effets améliorés.',
  'tierlist.disclaimer_ee_plus10':
    "Ce classement reflète la priorité d'amélioration de chaque Exclusive Equipment au niveau +10.",
  ...
  'tools.gear-usage-finder.mode_reco.desc':
    'Affiche uniquement les stats et objets qui apparaissent dans les recommandations de build. Filtrage strict de la stat principale.',
  ...
  'tools.coupon-codes.desc':
    'Obtenez tous les codes promo valides, expirés et à venir. Mis à jour régulièrement.',
  ...
  'tools.pull-simulator.no_pulls':
    'Sélectionnez votre/vos personnage(s) Focus et commencez à pull !',
  ...
  'tools.hero-tracker.untrack': 'Ne plus suivre',
  'tools.hero-tracker.level': 'Niveau',
  'tools.hero-tracker.skills': 'Compétences',
  'tools.hero-tracker.fusionLevel': 'Niveau de fusion',
  'tools.hero-tracker.affinity': 'Affinité',
  'tools.hero-tracker.transcend': 'Transcendance',
  'tools.hero-tracker.ee': 'Équipement exclusif',
  'tools.hero-tracker.eeFusion': 'EE de fusion',
  'tools.hero-tracker.needTitle': 'Matériaux nécessaires',
  'tools.hero-tracker.needEmpty': 'Rien à farmer — suivez un héros ou relevez une cible.',
  'tools.hero-tracker.gold': 'Or',
  'tools.hero-tracker.xp': 'EXP de héros',
  ...
  'tools.hero-tracker.resetConfirm': 'Effacer tous les héros suivis ?',
  'tools.hero-tracker.trackedCount': '{count} suivi(s)',
  'tools.hero-tracker.shoppingList': 'Liste de courses',
  'tools.hero-tracker.myHeroes': 'Mes héros',
  'tools.hero-tracker.addHero': 'Ajouter un héros',
  'tools.hero-tracker.untracked': '{count} non suivis',
  'tools.hero-tracker.heroNeeds': 'Nécessaire pour ce héros',
  'tools.hero-tracker.doneHero': 'Terminé — rien à farmer',
  'tools.hero-tracker.emptyTitle': 'Aucun héros suivi',
  'tools.hero-tracker.emptyCta': 'Choisir mes héros',
  'tools.hero-tracker.itemCount': '{count} objets',
  ...
  'tools.hero-tracker.noMatch': 'Aucun héros suivi ne correspond à ces filtres.',
  'tools.hero-tracker.piecesPremium': 'Premium',
  'tools.hero-tracker.piecesLimited': 'Limités',
  ...
  'tools.team-planner.chain_order.desc':
    "Glissez pour réorganiser la séquence d'attaque en chaîne.",
  'tools.team-planner.chain_valid': 'Chaîne valide : Start → Join → Finish',
  'tools.team-planner.chain_invalid':
    'Chaîne invalide — il faut un Start, un ou plusieurs Join et un Finish',
  ...
  'tools.team-planner.wip':
    'Cet outil est en cours de développement. Certaines fonctionnalités peuvent être incomplètes ou évoluer.',
  ...
  'tools.tier-list-maker.hint':
    'Glissez un élément dans un tier — ou touchez un élément, puis touchez un tier.',
  ...
  'tools.tier-list-maker.export_blocked':
    "Ton navigateur a bloqué l'export image — probablement un réglage anti-fingerprint/vie privée ou un souci de pilote graphique. Essaie un autre navigateur, ou autorise le canvas pour ce site.",
  ...
  'tools.damage-calculator.result.empty':
    'Choisissez un DPS et une cible pour calculer les dégâts.',
  ...
  'tools.damage-calculator.obs.no_baseline_hint':
    "Enregistré avant l'ajout de `calculatedAtSave` au schéma admin — re-sauvegardez dans l'admin pour combler.",
  // Share panel — export / import calc state
  'tools.damage-calculator.share.title': 'Partager',
  'tools.damage-calculator.share.subtitle':
    "Exportez votre configuration complète pour que quelqu'un puisse la reproduire, ou collez un partage pour charger le sien.",
  ...
  'tools.damage-calculator.share.copy_fallback':
    'Presse-papiers bloqué — texte sélectionné, appuyez sur Ctrl+C pour copier.',
  'tools.damage-calculator.share.imported': 'Importé avec succès.',
  'tools.damage-calculator.share.imported_with_warnings':
    'Importé avec des avertissements : {warnings}',
  ...
  'tools.damage-calculator.share.report_note_placeholder':
    'Contexte, étapes de reproduction, tout ce qui aide à déboguer…',
  'tools.damage-calculator.obs.divergent_only': 'Afficher uniquement les divergents',
  'tools.damage-calculator.obs.all_match':
    'Toutes les observations correspondent — aucune divergence.',
  ...
  'tools.damage-calculator.target.enrage_flag': 'Enragé',
  // Libellés lisibles des conditions (l'enum brut reste dans les tooltips)
  'tools.damage-calculator.context.cond.owner_resource': 'Condition de ressource unique',
  'tools.damage-calculator.context.cond.owner_has_buff': 'Le porteur a un buff',
  'tools.damage-calculator.context.cond.owner_has_all_buff': 'Le porteur a tous les buffs',
  'tools.damage-calculator.context.cond.owner_has_not_buff': "Le porteur n'a aucun buff",
  'tools.damage-calculator.context.cond.owner_alone': 'Seul sur le terrain',
  'tools.damage-calculator.context.cond.owner_together': 'Avec des alliés sur le terrain',
  'tools.damage-calculator.context.cond.owner_run_counter': "Condition de compteur d'actions",
  'tools.damage-calculator.context.cond.caster_has_buff': 'Le lanceur a un buff',
  'tools.damage-calculator.context.cond.caster_has_not_buff': "Le lanceur n'a aucun buff",
  'tools.damage-calculator.context.cond.caster_enemy_team_has_buff': "L'équipe ennemie a un buff",
  ...
  'tools.damage-calculator.context.cond.target_run_counter':
    "Condition de compteur d'actions de la cible",
  'tools.damage-calculator.context.cond.attacker_element_win': "Attaquant avantagé par l'élément",
  ...
  'tools.damage-calculator.equipment.ee_conditional_hint':
    'Se déclenche selon des conditions runtime (buffs cible/lanceur, série de kills, etc.) — à vérifier en jeu',
  ...
  'tools.damage-calculator.equipment.4pc_hint':
    "Déjà dans l'autre emplacement — choisissez à nouveau pour débloquer le set de 4",
  ...
  'guides.difficulty.league_1': 'Ligue normale',
  'guides.difficulty.league_2': 'Ligue difficile',
  'guides.difficulty.league_3': 'Ligue très difficile',
  'guides.difficulty.league_4': 'Ligue extrême',
  'guides.difficulty.tips_for':
    'Les conseils et équipes ci-dessous sont écrits pour la difficulté {difficulty}.',
  ...
  'legal.p3':
    "Outerpedia n'héberge ni ne redistribue les fichiers du jeu. Tous les éléments visuels sont affichés à des fins de commentaire et de documentation uniquement. Aucun contenu n'est mis à disposition pour le téléchargement ou la réutilisation.",
  'legal.p4':
    "Si vous êtes le détenteur légitime d'un contenu présent sur ce site et souhaitez son retrait, vous pouvez nous contacter ou contacter directement notre hébergeur. Nous répondrons rapidement à toute demande de retrait.",
  'legal.hosting': 'Hébergeur',
  'legal.p5':
    "Ce site est maintenu par un particulier. Conformément à la loi française (LCEN), les informations d'identification peuvent être communiquées aux autorités judiciaires sur demande légale via notre hébergeur.",
  ...
  'sys.class.passive.striker':
    "Génère 5 Action Points au début du tour. Génère 20 Action Points lors d'une attaque. Augmente la Critical Hit Chance de 5 %.",
  'sys.class.passive.defender':
    "Génère 5 Action Points au début du tour. Génère 35 Action Points lorsqu'il est touché. Augmente la Defense de 15 %.",
  'sys.class.passive.ranger': 'Génère 20 Action Points au début du tour.',
  'sys.class.passive.healer':
    "Génère 5 Action Points au début du tour. Génère 25 Action Points lorsqu'un allié est touché. Augmente la Health de 10 %.",
  'sys.class.passive.mage':
    "Génère 5 Action Points au début du tour. Génère des Action Points lors de l'utilisation de skills. Augmente l'Attack de 10 %.",
  ...
  'sys.subclass.info.attacker':
    'Un guerrier intrépide qui écrase ses ennemis grâce à une Attack élevée.',
  'sys.subclass.info.bruiser':
    'Un bagarreur spécialisé dans les combats prolongés grâce à un équilibre entre compétences offensives et défensives.',
  'sys.subclass.info.wizard':
    'Un maître de la magie qui sème le chaos sur le champ de bataille avec de puissants sorts.',
  'sys.subclass.info.enchanter':
    "Un cerveau du combat qui affaiblit les ennemis grâce à une variété d'effets additionnels.",
  'sys.subclass.info.vanguard': "Un leader qui domine l'ennemi grâce à une Speed élevée.",
  'sys.subclass.info.tactician':
    "Un maître stratège qui prend l'avantage en combat en accordant des Buff à ses alliés.",
  ...
  'sys.subclass.info.sage':
    'Un spécialiste du support qui contre les tentatives ennemies de gêner ses alliés en leur accordant divers effets.',
  ...
  'page.character.skill.priority_rule_2':
    "Chance d'effet, durée d'effet et réductions de cooldown.",
  'page.character.skill.priority_rule_3': 'Augmentations de dégâts (DPS uniquement)',
  'page.character.skill.priority_rule_chain':
    "Le Chain Passive peut être laissé au niveau 2 jusqu'à beaucoup plus tard ; l'augmentation des dégâts à la Weakness Gauge au niveau 5 est la seule partie intéressante, vous pouvez donc économiser des manuels de skills ici jusqu'à ce que les skills plus importants soient traités.",
  ...
  'page.character.gear.verdict.title': 'Flat ou % ?',
  'page.character.gear.verdict.hint':
    "Quelle version d'ATK / DEF / HP rapporte le plus par tick de reforge (gear 6★) pour ce perso, à l'investissement ci-dessous — l'équipement porté et les buffs ne changent pas la réponse.",
  'page.character.gear.verdict.badge_flat': 'flat',
  'page.character.gear.verdict.level': 'Niveau',
  'page.character.gear.verdict.tip_base':
    'Base au Nv.{level} : {base} (stats + évolutions{awak} — sans équipement, transcendance ni buffs)',
  'page.character.gear.verdict.tip_awak': ' + quirks',
  'page.character.gear.verdict.tip_flat': 'Tick flat : +{flat}',
  'page.character.gear.verdict.tip_pct': 'Tick % : +{pct} % × {base} = +{equiv}',
  'page.character.gear.verdict.tip_breakeven': 'Le % gagne au-dessus de {value} de base',
  'page.character.gear.verdict.tip_pct_wins': 'Le % rapporte plus par tick',
  'page.character.gear.verdict.tip_flat_wins': 'Le flat rapporte plus par tick',
  'page.character.gear.verdict.tip_close':
    "À moins de {margin} % l'un de l'autre — les deux se valent",
  ...
  // ─── 4-Cut Comics ────────────────────────────────────────────────────────
  'comics.description':
    "Parcourez les 4-cut comics officiels d'Outerplane. Cliquez sur une image pour la voir en taille réelle.",
  ...
  'progress.exportDesc':
    'Sauvegardez vos données de progression pour les restaurer sur un autre appareil.',
  ...
  'progress.resetConfirm':
    'Êtes-vous sûr de vouloir réinitialiser toute la progression ? Cette action est irréversible.',
  ...
  'progress.preciseCraftTimerDesc':
    'Définissez les jours restants si vous avez déjà crafté récemment.',
  ...
  'progress.clearDataDesc':
    'Cela effacera toutes les données du suivi de progression, y compris les paramètres. Utilisez ceci si vous rencontrez des problèmes.',
  'progress.clearDataConfirm':
  ...
  'progress.displayModeDesc':
    'Choisissez comment afficher les tâches quotidiennes, hebdomadaires et mensuelles',
