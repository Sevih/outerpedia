...
const jp: Record<TranslationKey, string> = {
  ...
  'page.character.gear.verdict.hint':
    'このキャラが下の育成状態のとき、★6装備の攻撃/防御/HPのサブステはどちらが1ティックあたり得か — 装備中のギアとバフは結果に影響しない。',
  'page.character.gear.verdict.badge_flat': '固定',
  'page.character.gear.verdict.level': 'レベル',
  'page.character.gear.verdict.tip_base':
    'Lv.{level}の基礎値：{base}（ステータス＋進化{awak} — 装備・超越・バフなし）',
  'page.character.gear.verdict.tip_awak': '＋ギアス',
  'page.character.gear.verdict.tip_flat': '固定ティック：+{flat}',
  'page.character.gear.verdict.tip_pct': '%ティック：+{pct}% × {base} = +{equiv}',
  'page.character.gear.verdict.tip_breakeven': '基礎値 {value} 以上で%が有利',
  'page.character.gear.verdict.tip_pct_wins': '%の方が1ティックあたり多い',
  'page.character.gear.verdict.tip_flat_wins': '固定値の方が1ティックあたり多い',
  'page.character.gear.verdict.tip_close': '差は{margin}%未満 — どちらでも可',
