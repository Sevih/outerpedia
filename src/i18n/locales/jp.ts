const jp = {
  ...
  'teamPlanner.teamName': 'チーム名',
  'teamPlanner.teamNamePlaceholder': '例: 飛天の塔 F100、火モノチームなど',
  'teamPlanner.share': '共有',
  'teamPlanner.copied': 'コピー済み！',
  'teamPlanner.edit': '編集',
  'teamPlanner.copyImage': '画像コピー',
  'teamPlanner.image': '画像',
  'teamPlanner.generating': '生成中...',
  'teamPlanner.modal.position': 'ポジション',
  'teamPlanner.modal.searchPlaceholder': '名前で検索...',
  'teamPlanner.filters.title': 'フィルター',
  'teamPlanner.filters.active': '有効',
  'teamPlanner.filters.found': '件',
  'teamPlanner.filters.buffLogic': 'バフロジック',
  'teamPlanner.filters.source': 'ソース',
  'teamPlanner.filters.effects': 'エフェクト',
  'teamPlanner.filters.addEffect': '+ エフェクト追加...',
  'teamPlanner.filters.clearAll': '全てクリア',
