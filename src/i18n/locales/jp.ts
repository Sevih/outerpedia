...
const jp: Record<TranslationKey, string> = {
  ...
  'equip.detail.reforge': '再錬成',
  'equip.detail.available': '回可能',
  'equip.detail.ascend': '昇華',
  'equip.detail.ascended': '昇華済み',
  'equip.detail.needs10': '+10が必要',
  'equip.detail.substats': 'サブステータス',
  'equip.detail.effect': '効果',
  'equip.detail.ascension': '特異点昇華',
  'equip.detail.bonus15': 'ボーナス効果 · +15で解放',
  'equip.detail.priority': '優先度',
  ...
  'tierlist.disclaimer_pvp':
    'このティアリストは6つ星超越とレベル10専用装備効果を前提としています。強化が解放されていない場合、結果が異なる場合があります。PvPコンテンツ専用です。',
  'tierlist.disclaimer_ee_base':
    'このランキングは各専用装備の基本レベル（Lv0）での解放優先度を反映しています。強化後の効果は考慮されていません。',
  ...
  'tools.gear-usage-finder.mode_reco.desc':
    'ビルド推奨に含まれるステータスと装備のみ表示。メインステータスで厳密にフィルタリング。',
  ...
  'tools.patch-history.zh_fallback':
    'このコンテンツは中国語では提供されていないため、英語で表示されています。',
  ...
  'tools.hero-tracker.untrack': '記録をやめる',
  'tools.hero-tracker.level': 'レベル',
  'tools.hero-tracker.skills': 'スキル',
  'tools.hero-tracker.fusionLevel': 'フュージョンレベル',
  ...
  'tools.hero-tracker.resetConfirm': '記録中のヒーローをすべて削除しますか？',
  'tools.hero-tracker.trackedCount': '{count}体を記録中',
  'tools.hero-tracker.shoppingList': '必要素材リスト',
  ...
  'tools.hero-tracker.itemCount': '{count}個',
  ...
  'tools.hero-tracker.noMatch': 'この条件に合う追跡中のヒーローはいません。',
  'tools.hero-tracker.piecesPremium': 'プレミアム',
  ...
  'tools.hero-tracker.rarityRules': '低レアリティのヒーロー',
  'tools.hero-tracker.hideShort': '非表示',
  'tools.hero-tracker.skipShort': '集計対象外',
  ...
  'tools.team-planner.wip':
    'このツールは開発中です。一部の機能が未完成または変更される場合があります。',
  ...
  'tools.tier-list-maker.hint':
    'アイテムをティアにドラッグするか、アイテムをタップしてからティアをタップしてください。',
  ...
  'tools.tier-list-maker.export_blocked':
    'ブラウザが画像の書き出しをブロックしました。プライバシー／フィンガープリント対策、またはグラフィックドライバーの問題の可能性があります。別のブラウザを試すか、このサイトでcanvasを許可してください。',
  ...
  'tools.tier-list-maker.tag.festival': 'フェス',
  ...
  'tools.damage-calculator.settings.guild': 'ギルドボーナス',
  'tools.damage-calculator.settings.premium': '称号バフ [高級ボディ]',
  ...
  'tools.damage-calculator.team.ee_owned': '専用装備所持',
  'tools.damage-calculator.team.ee_plus10': '専用装備 +10',
  ...
  'tools.damage-calculator.share.copy_fallback':
    'クリップボードがブロックされました — テキストを選択、Ctrl+Cでコピー。',
  ...
  'tools.damage-calculator.buffs.boss_passive': 'ボスのパッシブ',
  // Common UI strings
  ...
  'tools.damage-calculator.target.guild_buff_flag': 'ギルドボーナス適用',
  'tools.damage-calculator.target.title_buff_flag': '称号バフ適用',
  'tools.damage-calculator.target.enrage_flag': '激怒状態',
  // 条件の読みやすいラベル（生のenumはツールチップに残る）
  'tools.damage-calculator.context.cond.owner_resource': '固有リソースの条件',
  'tools.damage-calculator.context.cond.owner_has_buff': '自身にバフあり',
  'tools.damage-calculator.context.cond.owner_has_all_buff': '自身に全バフあり',
  'tools.damage-calculator.context.cond.owner_has_not_buff': '自身にバフなし',
  'tools.damage-calculator.context.cond.owner_alone': '自身のみ生存',
  'tools.damage-calculator.context.cond.owner_together': '味方が生存中',
  'tools.damage-calculator.context.cond.owner_run_counter': '行動回数の条件',
  'tools.damage-calculator.context.cond.caster_has_buff': '使用者にバフあり',
  'tools.damage-calculator.context.cond.caster_has_not_buff': '使用者にバフなし',
  'tools.damage-calculator.context.cond.caster_enemy_team_has_buff': '敵チームにバフあり',
  ...
  'guides.difficulty.league_1': 'ノーマルリーグ',
  'guides.difficulty.league_2': 'ハードリーグ',
  'guides.difficulty.league_3': 'ベリーハードリーグ',
  'guides.difficulty.league_4': 'エクストリームリーグ',
  'guides.difficulty.tips_for': '以下の攻略とパーティは{difficulty}向けです。',
  ...
  'coupons.redeem_ios':
    'iOS: <a href="https://coupon.outerplane.major7.kr/coupon?lang=en" target="_blank" rel="noopener noreferrer" class="underline text-cyan-400">公式サイトで引き換え</a>',
  ...
  'home.discord.description': '編成共有、質問、考察をコミュニティと一緒に楽しもう。',
  ...
  'legal.p3':
    'Outerpediaはゲームファイルのホスティングや再配布を行いません。すべてのビジュアルアセットは解説およびドキュメント目的でのみ表示されています。コンテンツのダウンロードや再利用はできません。',
  'legal.p4':
    '本サイトに掲載されているコンテンツの正当な所有者で削除を希望される場合は、当方またはホスティングプロバイダーに直接ご連絡ください。削除リクエストには速やかに対応いたします。',
  ...
  'sys.class.passive.striker':
    'ターン開始時、APが5回復する。ダメージを受けた時、APが20回復する。会心率が5%UPする。',
  'sys.class.passive.defender':
    'ターン開始時、APが5回復する。ダメージを受けた時、APが35回復する。防御力が15%UPする。',
  'sys.class.passive.ranger': 'ターン開始時、APが20回復する。',
  'sys.class.passive.healer':
    'ターン開始時、APが5回復する。味方がダメージを受けた時、APが25回復する。HPが10%UPする。',
  'sys.class.passive.mage':
    'ターン開始時、APが5回復する。スキル使用時、個別AP獲得する。攻撃力が10%UPする。',
  ...
  'characters.filters.tag_group.limited': '限定ユニット',
  ...
  'page.character.skill.priority_rule_chain':
    'チェインパッシブはしばらくレベル2のままで構いません。レベル5の弱点ゲージダメージ増加だけが重要なので、より重要なスキルが完了するまでスキル教本を節約できます。',
  ...
  'page.character.gear.verdict.title': '固定値か%か',
  'page.character.gear.verdict.badge_flat': '固定',
  'page.character.gear.verdict.badge_even': '同等',
  'page.character.gear.verdict.level': 'レベル',
  'page.character.gear.verdict.calc_line': '+{pct}% × {base} = +{equiv}（固定 +{flat}）',
  'page.character.gear.verdict.calc_note':
    '★6装備のリフォージ1ティックあたり。Lv.{level}の基礎値 = ステータス＋進化{awak} — 装備中のギア・超越・バフは結果に影響しない。',
  'page.character.gear.verdict.calc_breakeven': '基礎値が {list} を超えると%が有利。',
  'page.character.gear.verdict.calc_awak': '＋ギアス',
  'page.character.gear.verdict.pct_wins': '%の方が1ティックあたり多い',
  'page.character.gear.verdict.flat_wins': '固定値の方が1ティックあたり多い',
  'page.character.gear.verdict.close': '差は{margin}%未満 — どちらでも可',
  ...
  // ─── 4-Cut Comics ────────────────────────────────────────────────────────
  'comics.description':
    'アウタープレイン公式4コマ漫画を閲覧できます。画像をクリックすると拡大表示されます。',
  ...
  'progress.clearDataDesc':
    '設定を含むすべての進行状況データを削除します。問題が発生した場合に使用してください。',
