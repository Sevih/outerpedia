...
const zh: Record<TranslationKey, string> = {
  ...
  'tools.damage-calculator.settings.subtitle': '天赋、图鉴增益',
  ...
  'tools.damage-calculator.attacker.tier_label': '超越等级',
  ...
  'tools.damage-calculator.target.monster': '怪物',
  'tools.damage-calculator.target.resolved': '实际数值',
  'tools.damage-calculator.target.hp_bars': '{n}条血',
  'tools.damage-calculator.target.spawn_adv': '出场 +{pct}% ATK/DEF',
  'tools.damage-calculator.context.title': '环境',
  'tools.damage-calculator.context.content_type': '内容类型',
  'tools.damage-calculator.context.type_pve': 'PvE',
  'tools.damage-calculator.context.type_arena': '竞技场',
  'tools.damage-calculator.context.type_rtpvp': '实时PvP',
  'tools.damage-calculator.context.targets_hit': '目标数',
  'tools.damage-calculator.context.penalty_cycle': '惩罚周期',
  'tools.damage-calculator.context.penalty_note': '第10回合起的PvP惩罚 — 双方均适用。',
  'tools.damage-calculator.buffs.from_kits': '+ 从技能组',
  'tools.damage-calculator.buffs.kits_soon': '需要技能组增益数据 — 与引擎一同推出',
  'tools.damage-calculator.buffs.on_attacker': '加给攻击方',
  'tools.damage-calculator.buffs.on_target': '加给目标',
  'tools.damage-calculator.buffs.value': '数值',
  'tools.damage-calculator.buffs.stacks': '层数',
  'tools.damage-calculator.report.engine_wip': '计算引擎尚未接入 — 以占位数值展示最终布局。',
  ...
  'tools.damage-calculator.report.expected': '期望伤害',
  'tools.damage-calculator.report.expected_note': '所有分支加权平均',
