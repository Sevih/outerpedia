...
const zh: Record<TranslationKey, string> = {
  ...
  'page.guides.meta_title': '异域战记攻略 – {monthYear}',
  ...
  'page.guide.updating_disclaimer': '本篇攻略正在针对此版本进行更新。部分推荐内容可能会有所变动。',
  ...
  'guides.recommended.phase1': '阶段 1 推荐角色',
  'guides.recommended.phase2': '阶段 2 推荐角色',
  ...
  // Guild Raid
  'guildraid.geas': '吉亚斯',
  'guildraid.geas.desc': '切换吉亚斯来计算你的分数倍率。激活惩罚吉亚斯会增加难度但提高分数。',
  ...
  'coupons.redeem.disclaimer':
    '兑换码将直接发送至异域战记官方兑换服务。Outerpedia 不会保存任何信息。',
  ...
  'page.character.core_fusion.skill_info':
    '解锁核心融合需要{unlockCost}个{material}（技能从Lv.1开始）。每次升级消耗{upgradeCost}个{material}，所有技能等级提升1级。总计: {totalCost}个{material}即可全部满级。',
