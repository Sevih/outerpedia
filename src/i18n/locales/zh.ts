...
const zh: Record<TranslationKey, string> = {
  ...
  'tierlist.disclaimer_ee_base':
    '本排行榜反映了各专属装备在基础等级（Lv0），及解锁优先级。不考虑强化后的效果。',
  ...
  'tools.tier-list-maker.desc':
    '创建并分享你自己的 Outerplane 梯队表——为角色、专属装备和首领评级，然后分享链接或导出图片。',
  ...
  'tools.damage-calculator.desc':
    '精确计算角色造成的伤害——与游戏内公式逐位一致。选择攻击者、目标、装备和增益来查看结果。',
  'tools.damage-calculator.disclaimer':
    '开发中 — 伤害计算器正在积极开发中。在调整贡献项并添加装备/增益支持的过程中，结果可能与游戏内数值存在偏差。',
  ...
  'page.guides.description': '异域战记攻略指南：冒险关卡、Boss战、公会突袭、世界首领、新手攻略。',
  ...
  'guides.difficulty.tips_for': '以下攻略与队伍配置针对{difficulty}。',
  ...
  'page.legal.description': 'Outerpedia法律声明、免责条款及内容使用政策 — 非官方异域战记粉丝项目。',
  ...
  'coupons.redeem.disclaimer':
    '兑换码将直接发送至 Outerplane 官方兑换服务。Outerpedia 不会保存任何信息。',
  ...
  'legal.p1':
    '本声明为Outerpedia（一个专注于游戏《异域战记》的非官方粉丝项目）的法律免责声明。本站使用的所有名称、图像和其他资产均为VAGAMES CORP或其各自所有者的财产。本站与VAGAMES CORP无任何关联、认可或赞助关系。',
  ...
  'page.character.skill.priority_rule_chain':
    '连携被动可以保持2级不升，直到其他技能完成。5级的WG伤害提升是唯一有价值的部分，在更重要的技能升满之前可以节省技能书。',
  ...
  'page.character.stats.quirks': '契印',
  ...
  'ost.disclaimer.line1': '这些原声音乐经开发者（VAGames）许可，仅供个人非商业用途使用。',
