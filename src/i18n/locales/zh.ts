...
const zh: Record<TranslationKey, string> = {
  ...
  'tools.tier-list-maker.tag.limited': 'FES',
  ...
  'tools.damage-calculator.desc':
    '精确计算角色造成的伤害——使用游戏内公式。选择攻击者、目标、装备和增益来查看结果。',
  ...
  'page.character.gear.verdict.hint':
    '在下方的养成状态下，该角色 6★ 装备的攻击/防御/生命副属性哪一种每次重铸收益更高 — 已穿戴装备与增益不影响结果。',
  'page.character.gear.verdict.badge_flat': '固定',
  'page.character.gear.verdict.level': '等级',
  'page.character.gear.verdict.tip_base':
    'Lv.{level} 基础值：{base}（属性 + 进化{awak} — 不含装备、超越与增益）',
  'page.character.gear.verdict.tip_awak': ' + 天赋',
  'page.character.gear.verdict.tip_flat': '固定值档：+{flat}',
  'page.character.gear.verdict.tip_pct': '%档：+{pct}% × {base} = +{equiv}',
  'page.character.gear.verdict.tip_breakeven': '基础值高于 {value} 时 % 更优',
  'page.character.gear.verdict.tip_pct_wins': '% 每档收益更高',
  'page.character.gear.verdict.tip_flat_wins': '固定值每档收益更高',
  'page.character.gear.verdict.tip_close': '两者相差不到 {margin}% — 皆可',
