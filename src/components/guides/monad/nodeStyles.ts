...
export const NODE_STYLES: Record<MonadNodeType, NodeStyle> = {
  start: { icon: 'CM_Monad_Node_Icon_01', filter: YELLOW, textColor: 'text-monad-milestone' },
  tending: { icon: 'CM_Monad_Node_Icon_01', filter: YELLOW, textColor: 'text-monad-milestone' },
  bending: { icon: 'CM_Monad_Node_Icon_01', filter: YELLOW, textColor: 'text-monad-milestone' },
  nending: { icon: 'CM_Monad_Node_Icon_01', filter: YELLOW, textColor: 'text-monad-milestone' },
  path: { icon: 'CM_Monad_Node_Icon_08', filter: YELLOW, textColor: 'text-monad-milestone' },
  relic: { icon: 'CM_Monad_Node_Icon_05', filter: GREEN, textColor: 'text-monad-explore' },
  moment: { icon: 'CM_Monad_Node_Icon_03', filter: GREEN2, textColor: 'text-monad-explore' },
  combat: { icon: 'CM_Monad_Node_Icon_02', filter: RED, textColor: 'text-monad-combat' },
  elite: { icon: 'CM_Monad_Node_Icon_04', filter: RED, textColor: 'text-monad-combat' },
  pinnacle: { icon: 'CM_Monad_Node_Icon_06', filter: RED, textColor: 'text-monad-combat' },
  final: { icon: 'CM_Monad_Node_Icon_07', filter: RED, textColor: 'text-monad-combat' },
  eldritch: { icon: 'CM_Monad_Node_Icon_09', filter: BLUE, textColor: 'text-monad-story' },
  saga: { icon: 'CM_Monad_Node_Icon_10', filter: BLUE, textColor: 'text-monad-story' },
  cube: { icon: 'CM_Monad_Node_Icon_05', filter: BLUE, textColor: 'text-monad-story' },
