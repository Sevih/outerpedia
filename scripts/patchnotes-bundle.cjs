...
function processSection(section) {
  ...
  results.sort((a, b) => b.date_iso.localeCompare(a.date_iso));
  fs.writeFileSync(JSON_OUT, JSON.stringify({ [KEY]: results }, null, 2), 'utf8');

  console.log(`✅ [${section}] ${results.length} élément(s) → ${JSON_OUT}`);
